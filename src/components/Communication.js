...
const Communication = (props) => (
	<div className="auth">
		...
		<div className="grant-access">
			...
			<button onClick={props.handleInvitation} data-ref="reject" className="primary-button">
				Reject
			</button>
			<button onClick={props.handleInvitation} data-ref="accept" className="primary-button">
				Accept
			</button>
		</div>
